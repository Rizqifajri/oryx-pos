...
function PaymentFinishContent() {
  ...
  const { data: payment, isLoading } = usePaymentStatus(orderId);
        ...
        {payment && (
          <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-green-600 font-semibold">{payment.status.toUpperCase()}</span>
            </div>
          </div>
        )}

        <p className="text-sm text-gray-500 mb-6">
          Thank you for your payment. Food will be served shortly!
        </p>
